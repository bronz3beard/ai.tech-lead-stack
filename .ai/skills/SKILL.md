...
- [[mission-architect]] : Master Blueprint Engine (Strategy -> Plan -> Deliver).
- [[planning-expert]] : Precise, lightweight daily planning tool.
- [[regression-bug-fix]] : Unified remedy for QA, DR, and regression feedback.
...
- [[changelog-generator]] : Git history to release notes.
- [[daily-standup]] : Generates concise daily status reports.

---

## 🤖 Agent-Internal Core (Internal)

- [[verification-auditor]] : Master Agent-internal quality gatekeeper.
