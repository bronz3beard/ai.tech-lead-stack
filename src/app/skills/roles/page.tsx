      ...
      <div className="max-w-7xl mx-auto space-y-12">
        <header className="text-center space-y-4">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto">
            Discover specialized AI capabilities tailored for your role. Enhance
            your workflow with these intelligent assistants.
          </p>
        </header>
        ...
        <section className="space-y-6">
          <div className="flex items-center space-x-3 border-b border-slate-700 pb-2">
            ...
            <span className="bg-emerald-500/20 text-emerald-400 text-xs px-2 py-1 rounded-full uppercase tracking-wider">
              Full Stack Access
            </span>
          </div>
          ...
          <div className="bg-slate-800/40 rounded-3xl p-8 md:p-12 border border-slate-700/50 space-y-10">
            <p className="text-slate-300 text-lg md:text-xl max-w-3xl leading-relaxed">
              Developers have unhindered access to every capability in the
              Interlink system. The following represents the specialized AI
              tools available for architectural, logic, and operational
              excellence.
            </p>
    ...
    <div
      className={`bg-slate-900/40 rounded-lg border transition-all duration-300 overflow-hidden ${
        isExpanded
          ...
          : 'border-slate-700/30 hover:border-emerald-500/50'
      }`}
    >
      <button
      ...
      >
        <div className="flex items-center space-x-3">
          <Cpu
            className={`w-4 h-4 transition-colors ${isExpanded ? 'text-emerald-400' : 'text-emerald-500/50 group-hover:text-emerald-400'}`}
          />
      ...
      {isExpanded && (
        <div className="px-4 pb-6 pt-2 space-y-6 border-t border-slate-800/50 bg-slate-900/20">
          <div className="space-y-2">
            <h4 className="text-xs font-semibold text-emerald-500/70 uppercase tracking-widest">
              Description
            </h4>
...
function SkillCard({
  ...
  return (
    <div className="bg-slate-800/80 border border-slate-700 rounded-xl p-6 hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-blue-500/10 hover:-translate-y-1 transition-all duration-300 flex flex-col h-full">
      ...
      <p className="text-slate-300 text-base mb-6 grow">{skill.description}</p>
