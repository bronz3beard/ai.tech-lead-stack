...
describe('UserResolver', () => {
  ...
  describe('getUserEmail', () => {
    it('should return email from GitHub CLI if available', () => {
      ...
      expect(child_process.execSync).toHaveBeenCalledWith('gh api user -q .email', { stdio: 'pipe' });
    });
    ...
    it('should fallback to git config if GitHub CLI returns null string', () => {
      ...
      expect(child_process.execSync).toHaveBeenCalledWith('gh api user -q .email', { stdio: 'pipe' });
      expect(child_process.execSync).toHaveBeenCalledWith('git config --global user.email', { stdio: 'pipe' });
    });
  ...
  describe('getUserName', () => {
    it('should return name from git config if available', () => {
      ...
      expect(child_process.execSync).toHaveBeenCalledWith('git config --global user.name', { stdio: 'pipe' });
    });
