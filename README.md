...
| **`dev-team-orchestrator`**     | The Flagship Orchestration Engine. An agent-agnostic "dev team" managed by you as a technical product manager.                                                                                                                                                                    | Sizes the crew to the task, runs several task lanes in parallel without collision, interviews the human only at gates, and files friction defects autonomously.                                                     | Use when you need a multi-persona dev team to tackle complex tasks with proper lane tracking.                       | ~2500 tokens           |
