...
_Model access varies by platform. On some platforms every paid tier shares one
model lineup, so cross-vendor L0 isolation is reachable on the entry tier; what
the higher tiers buy is throughput. Check your provider's current model list._
...
| [`docs/known-issues-subscription-tiers.md`](./docs/known-issues-subscription-tiers.md)                                         | Tracker for known skill defects on subscription tiers. |
...
| :-------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------- | :-------------------- | :--------------------- |
| **`dev-team-orchestrator`** | [DEV-TEAM · FULL · MCP] The flagship orchestration skill: an agent-agnostic "dev team" you manage as a technical product manager. Sizes the crew to the task, runs multiple task lanes in parallel without collision, interviews the human only at gates, and files friction defects automatically on its own repo.                                                                                                                                                                                      | -                                                                                                                                                   | -                                                                                                   | read-only, write, mcp | ~2500 tokens           |
