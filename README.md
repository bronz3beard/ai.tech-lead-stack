...
> **[docs/mcp-proxy-setup.md](docs/mcp-proxy-setup.md)**.
...
not a failure. See
[Running the stack behind an upstream MCP proxy](docs/mcp-proxy-setup.md).
