...
name: dev-team
description: >-
  [DEV-TEAM · FULL · MCP] The flagship orchestration workflow for an agentic dev
  team
modes:
  - write
---
...
> This file (`.agents/workflows/dev-team.md`) is a workflow launcher stub, NOT the skill definition.
