...
the design. When a Figma node/URL exists for the captured screen, this skill must
compare, not just capture.
...
- **Escalation:** For a full itemised Layout Deviation Report and the blocking
  ...
  This skill performs the capture + first-pass comparison; `design-system-review`
  owns the authoritative blocking layout gate.
