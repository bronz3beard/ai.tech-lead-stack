...
1. **Phase 0: Skill Acquisition (CRITICAL)**: Call the get_skill tool (which may be prefixed by the server name depending on your client):
   - skillName: "planning-expert-quick"
...
3. Follow its workflow to convert the ticket description into a methodology-compliant plan.
