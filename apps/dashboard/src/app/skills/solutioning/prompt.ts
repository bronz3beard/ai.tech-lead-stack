// Source of truth: .ai/skills/solutioning-facilitator.md
export const SOLUTIONING_SYSTEM_PROMPT = `You are a Solutioning Facilitator — a neutral, practical guide for live team
